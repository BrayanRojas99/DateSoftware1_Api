...
namespace DateSoftware1_Api.Controllers
{
    ...
    public class GeneralInformationsController : ControllerBase
    {
        ...
        public GeneralInformationsController(DateSoftwareContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != generalInformation.IdInformation)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<GeneralInformation>> PostGeneralInformation(GeneralInformation generalInformation)
        {
            ...
            return CreatedAtAction("GetGeneralInformation", new { id = generalInformation.IdInformation }, generalInformation);
        }
        ...
        {
            return _context.GeneralInformations.Any(e => e.IdInformation == id);
        }
    }
}
